...
try:
    ...
    def test_client() -> TestClientProtocol:
        ...
        @app.route("/anonymous")
        async def empty_anonymous_route() -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/anonymous/<org>")
        async def anonymous_route(org: str) -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/anonymous/<org>/<arg>")
        async def anonymous_route_with_arg(org: str, arg: str) -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/invited")
        async def empty_invited_route() -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/invited/<org>")
        async def invited_route(org: str) -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/invited/<org>/<arg>")
        async def invited_route_with_arg(org: str, arg: str) -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/authenticated")
        async def empty_authenticated_route() -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/authenticated/<org>")
        async def authenticated_route(org: str) -> str:  # type: ignore[misc]
            return "Hello World"

        @app.route("/authenticated/<org>/<arg>")
        async def authenticated_route_with_arg(org: str, arg: str) -> str:  # type: ignore[misc]
            return "Hello World"

...
def bootstrap_organization(config, addr, password, device_label, human_label, human_email, **kwargs):
    """
    ...
    with cli_exception_handler(config.debug):
        ...
        trio_run(_bootstrap_organization, config, addr, password, device_label, human_label, human_email)
